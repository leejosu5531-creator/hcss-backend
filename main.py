...
def save_layout(req: LayoutModel):
    try:
        ...
        return {"status":"success","date":req.date_str,"total_seats":req.total_seats,
                "saved_at":saved_at,"verified":True,"code_version":"2026-09-20-HCSS-v6"}
    ...
    try:
        ...
        if not saved:
            return {"status":"not_found","date":req.date_str,"total_seats":req.total_seats,
                    "code_version":"2026-09-20-HCSS-v6"}
        counts=[]
        ...
        return {"status":"success","date":req.date_str,"total_seats":req.total_seats,
                ...
                "data_source":source,"code_version":"2026-09-20-HCSS-v6"}
    except Exception as e:
...
def health_check():
    ...
    return {"status": "ok", "code_version": "2026-09-20-HCSS-v6"}
