...
BASE_SEATS = {
    ...
    3: {"S": {"direction":"R2L", "names":["김지은","노희령","류은채","박유림","윤선미"]}, "T": {"direction":"R2L", "names":["강종훈","권재훈","하효동","권영훈","김기형"]}, "B": {"direction":"L2R", "names":["이재관","정동근","목현성","전병대","성준호","권상대b","이입교"]}},
...
@app.get("/health")
def health_check():
    return {"status": "ok", "code_version": "2026-09-15-seat-direction-final-fix"}
...
def run_allocation(req: RequestModel):
    try:
        ...
        return {
            "status": "success",
            "code_version": "2026-09-15-seat-direction-final-fix",
            "date": str(target),
