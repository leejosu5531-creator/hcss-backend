...
def health_check():
    ...
    return {"status": "ok", "code_version": "2026-09-12-force-body-refresh-v2"}
...
def run_allocation(req: RequestModel):
    try:
        ...
        try:
            ...
            file_bytes, mtime = get_excel_bytes(
                service, file_id, force_refresh=req.force_refresh
            )
        except Exception:
        ...
        return {
            "status": "success",
            "code_version": "2026-09-12-force-body-refresh-v2",
            "date": str(target),
